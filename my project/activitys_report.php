        ...
        <aside class="sidebar">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li><a href="activitys_report.php" class="active"><i class="fas fa-calendar-alt"></i> Activity</a></li>
        ...
        <main class="main-content">
            ...
            <div class="report-container">
                <header class="report-header">
                    <h1><i class="fas fa-calendar-alt"></i> Activity Report Overview</h1>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if (isset($conn) && $conn) {
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM activities ORDER BY activityNo DESC");
                                ...
                                if ($query) {
                                    if (mysqli_num_rows($query) > 0) {
                                        while ($records = mysqli_fetch_array($query)) {
                                            ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($records['activityNo']); ?></td>
                                                <td><?php echo htmlspecialchars($records['description']); ?></td>
                                                <td><?php echo htmlspecialchars($records['clubId']); ?></td>
                                                <td class="action-group">
                                                    <a href="./delete.php?delete_id=<?php echo $records['activityNo']; ?>" class="action-button delete">
                                                        <i class="fas fa-trash-alt"></i> DELETE
                                                    </a>
                                                    <a href="./update.php?update_id=<?php echo $records['activityNo']; ?>" class="action-button update">
