        ...
        <aside class="sidebar">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li><a href="clubs_report.php" class="active"><i class="fas fa-users"></i> Clubs</a></li>
        ...
        <main class="main-content">
            ...
            <div class="report-container">
                <header class="report-header">
                    <h1><i class="fas fa-calendar-alt"></i> Clubs Report Overview</h1>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if (isset($conn) && $conn) {
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM clubs ORDER BY clubId DESC");
                                    ...
                                    if (mysqli_num_rows($query) > 0) {
                                        while ($records = mysqli_fetch_array($query)) {
                                            ...
                                            <tr class="my-style">
                                                ...
                                                <td><?php echo htmlspecialchars($records['clubName']); ?></td>
                                                <td class="action-group">
                                                    <a href="./delete_club.php?delete_id=<?php echo $records['clubId']; ?>" class="action-button delete">
                                                        <i class="fas fa-trash-alt"></i> DELETE
                                                    </a>
                                                    <a href="./update_club.php?update_id=<?php echo $records['clubId']; ?>" class="action-button update">
